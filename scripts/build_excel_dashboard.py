...
def create_dashboard(wb, df, kpi_df, timeline_df):
    ...
    # Section: Sources & Latency Waterfall Table
    start_row = 12
...
def main():
    ...
    print("\n✓ Workbook successfully generated:")
    print(f"  {OUTPUT_FILE}")
    print("========================================================\n")
